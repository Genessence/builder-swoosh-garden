...
export default function MaterialInward() {
  ...
  const [selectedInwardRecord, setSelectedInwardRecord] = useState<
    (typeof mockInwardHistory)[0] | null
  >(null);
  ...
  const getStepColor = (status: string) => {
    switch (status) {
      ...
      case "active":
        return "bg-industrial-warning text-white";
      default:
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("truckId", e.target.value)
                    }
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("tareWeight", e.target.value)
                    }
                    placeholder="0"
                  />
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("itemCount", e.target.value)
                    }
                ...
                {qualityChecks.map((check) => (
                  ...
                  >
                    ...
                    <RadioGroup
                      ...
                      onValueChange={(value) =>
                        handleQualityCheck(check.id, value)
                      }
            ...
            <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    ...
                    <span className="ml-2 font-medium">
                      {formData.truckId || "N/A"}
                    </span>
                  </div>
                  <div>
                    <span className="text-gray-600">Net Weight:</span>
                    <span className="ml-2 font-medium">
                      {formData.netWeight || "N/A"} kg
                    </span>
                  </div>
                  <div>
                    <span className="text-gray-600">PO Number:</span>
                    <span className="ml-2 font-medium">
                      {formData.poNumber || "N/A"}
                    </span>
                  </div>
                  <div>
                    <span className="text-gray-600">RFID Tags:</span>
                    <span className="ml-2 font-medium">
                      {formData.rfidTags.length}
                    </span>
                  </div>
                </div>
              </div>
              <div className="flex justify-center">
                <Button
                  ...
                  className="bg-industrial-success hover:bg-industrial-success/90 px-8"
                >
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-gray-600">
            Streamlined inward process with quality control and RFID tracking
          </p>
        </div>
                ...
                return (
                  <div key={step.id} className="flex items-center">
                    <div className="flex flex-col items-center">
                      <div
                        className={`w-10 h-10 rounded-full flex items-center justify-center ${getStepColor(status)}`}
                      >
                    ...
                    {!isLast && (
                      <div
                        className={`h-1 w-16 mx-2 ${status === "completed" ? "bg-industrial-success" : "bg-gray-200"}`}
                      />
                    )}
                  </div>
                );
            ...
            <div className="space-y-4">
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Position RFID tag in camera view
                </p>
        ...
        <Dialog
          open={isViewInwardModalOpen}
          onOpenChange={setIsViewInwardModalOpen}
        >
          <DialogContent className="max-w-2xl">
                ...
                <div className="border-t pt-4 space-y-4">
                  <div>
                    ...
                    <p className="flex items-center mt-1">
                      ...
                      {new Date(selectedInwardRecord.date).toLocaleDateString(
                        "en-US",
                        {
                          weekday: "long",
                          year: "numeric",
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      ...
                      <div>
                        ...
                        <p className="font-medium">
                          {selectedInwardRecord.status === "Completed"
                            ? selectedInwardRecord.items.split(" ")[0]
                            : "Pending"}
                        </p>
                      </div>
                      <div>
            ...
            <DialogFooter>
              <Button
                variant="outline"
                onClick={() => setIsViewInwardModalOpen(false)}
              >
                Close
              </Button>
